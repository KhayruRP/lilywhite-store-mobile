...
class _ItemsFormPageState extends State<ItemsFormPage> {
  ...
  final List<String> _categories = ['jersey', 'socks', 'shorts', 'shoes'];
  @override
  Widget build(BuildContext context) {
    final request = context.watch<CookieRequest>();
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('Add Items Form')),
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        final response = await request.postJson(
                          "https://khayru-rafamanda-storelilywhites.pbp.cs.ui.ac.id/create-flutter/",
                          jsonEncode({
                            "title": _title,
                            "price": _price,
